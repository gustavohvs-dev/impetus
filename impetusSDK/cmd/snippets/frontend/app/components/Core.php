...
class Core
{
    ...
    static function credentials($userData)
    {
        ...
        echo '<input type="hidden" id="endPoint" value="' . $systemConfig['endPoint'] . '">';
            ...
            <div class="container-fluid">
                <div class="row text-muted">
                    <div class="col-6 text-start">
                        <p class="mb-0">
                            <a href="#" class="text-muted"><strong>Impetus Framework</strong></a> &copy;
                        </p>
                    </div>
                    <!--<div class="col-6 text-end">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a class="text-muted" href="documentation">Documentação do webservice</a>
                            </li>
                        </ul>
                    </div>-->
                </div>
