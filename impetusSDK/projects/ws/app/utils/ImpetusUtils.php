    ...
    static function validator($name, $request, $config)
    {
        ...
        if($nullableParam == false && ($typeParamValue != 'boolean' && $typeParamValue != 'number' && $typeParamValue != 'int')){
            ...
            if($validate == true){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' não pode ser vazio."
                ];
            }
        }
        ...
        if($lengthParam == true){
            ...
            if($validate == true){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' excede quantidade máxima de caracteres (" . $lengthParamMaxValue . ")"
                ];
            }
            ...
            if($validate == true){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' não possui caracteres suficientes (" . $lengthParamMinValue . ")"
                ];
            }
        }
        ...
        if($typeParam == true){
            if($typeParamValue == "number"){
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é um número válido."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é uma data válida."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é um número inteiro."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é um email válido."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é um valor booleano."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é um valor datetime (d/m/Y H:i:s)."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é uma senha segura. Deve conter mais que 8 caracteres, ao menos uma letra e um número."
                    ];
                }
                ...
                if($validate == false){
                    return [
                        "status" => 0,
                        "info" => "Campo '" . strtoupper($name) . "' não é uma senha segura. Deve conter mais que 8 caracteres, ao menos uma letra, um número e um caracter especial."
                    ];
                }
        ...
        if($enumParam == true && $string != null){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Valor '" . strtoupper($name) . "' não disponível nas opções (Opções disponíveis: " . $itens . ")"
                ];
            }
        }
        ...
        if($greaterThan == true && ($typeParamValue=="number" || $typeParamValue=="int")){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' deve ser maior que (" . $greaterThanParamValue . ")."
                ];
            }
        }
        ...
        if($greaterThanOrEqual == true && ($typeParamValue=="number" || $typeParamValue=="int")){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' deve ser maior ou igual a (" . $greaterThanOrEqualParamValue . ")."
                ];
            }
        }
        ...
        if($lessThan == true && ($typeParamValue=="number" || $typeParamValue=="int")){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' deve ser menor que (" . $lessThanParamValue . ")."
                ];
            }
        }
        ...
        if($lessThanOrEqual == true && ($typeParamValue=="number" || $typeParamValue=="int")){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' deve ser menor ou igual a (" . $lessThanOrEqualParamValue . ")."
                ];
            }
        }
        ...
        if($between == true && ($typeParamValue=="number" || $typeParamValue=="int")){
            ...
            if($validate == false){
                return [
                    "status" => 0,
                    "info" => "Campo '" . strtoupper($name) . "' deve estar entre (" . $betweenParamMinValue . ") e (" . $betweenParamMaxValue . ")."
                ];
            }
        }
