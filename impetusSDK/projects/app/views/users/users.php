										...
										<div class="col">
											...
											<form id="datatable-filters" class="collapse">
												<div class="row">
													...
													<?php Core::select("Pessoa", "filter-pessoaid", "pessoas/select", "status: 'ACTIVE',nome: this.value", 8);?>
												</div>
						...
						<div class="modal-body">
							<form id="form-view-users">
								<div class="row">
									...
									<div class="form-group col-md-12 mb-2">
										<label for="form-view-users-pessoaNome">Vínculo de pessoa</label>
										<input type="text" id="form-view-users-pessoaNome" class="form-control" value=""
											readonly>
									</div>
									<div class="form-group col-md-12 mb-2">
						...
						<div class="modal-body">
							<form id="form-create-users">
								<div class="row">
									...
									<?php Core::select("Pessoa", "form-create-users-pessoaid", "pessoas/select", "status: 'ACTIVE', nome: this.value");?>
									<!-- Fim Select -->
									<div class="form-group col-md-12 mb-2">
						...
						<div class="modal-body">
							<form id="form-edit-users">
								<div class="row">
									...
									<?php Core::select("Pessoa", "form-edit-users-pessoaid", "pessoas/select", "status: 'ACTIVE', nome: this.value");?>
									<div class="form-group col-md-12 mb-2">
